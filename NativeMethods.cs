...
namespace MacroMan
{
    ...
    internal static class NativeMethods
    {
        ...
        public static void SendKeyUp(IntPtr windowHandle, IntPtr keyboardLayoutHandle, UInt32 key)
        {
            UInt32 scanCode = (1 | (MapVirtualKeyEx(key, MAPVK_TYPE.MAPVK_VK_TO_VSC, keyboardLayoutHandle) << 16));
            // 0xC0000000 = previous key state (1) + transition state (1)
            UInt32 lParam = scanCode | 0xC0000000;
            SendMessage(windowHandle, (UInt32)WINDOW_MESSAGE.WM_KEYUP, (IntPtr)key, (IntPtr)lParam);
        }
